...
function SmokeHeader() {
  ...
  return (
    <View style={styles.headerCard}>
      <Text style={styles.headerTitle}>{t("smoke.title")}</Text>
      <Text style={styles.headerBody}>{t("smoke.desc1")}</Text>
      <Text style={styles.headerBody}>{t("smoke.desc2")}</Text>
      <Text style={styles.headerBody}>{t("smoke.desc3")}</Text>
    </View>
  );
}
